-- ==============================================================================
-- SCRIPT DE MIGRATION : AJOUT DU KYC ET DU TYPE DE STRUCTURE
-- ==============================================================================

-- 1. Ajouter les colonnes à la table public.agencies
...
-- 2. Ajouter les colonnes à la table public.agency_registration_requests
...
-- 3. Mettre à jour la fonction stockée approve_agency_request
