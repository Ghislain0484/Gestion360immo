...
`;
  ...
  static async generateManagementContractForOwner(
    ...
    return {
      ...
      startDate: new Date(),
      commissionRate,
      commissionAmount: 0, // Sera calculé lors de la location
  ...
  static async generateRentalContractForTenant(
    ...
    return {
      ...
      agencyId: agencyData.id,
      startDate: new Date(),
      endDate: new Date(Date.now() + (contractData.duration * 30 * 24 * 60 * 60 * 1000)),
      monthlyRent: contractData.monthlyRent,
      deposit: contractData.deposit,
      charges: contractData.charges,
      commissionRate: 10,
      commissionAmount: contractData.monthlyRent * 0.1,
