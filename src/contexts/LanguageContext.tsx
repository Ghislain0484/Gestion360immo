...
const commonTranslations: Record<string, string> = {
  ...
  "Ravi de vous revoir,": "Delighted to see you again,",
  "Tout semble optimal aujourd'hui. Voici un aperçu de l'activité de votre agence.": "Everything looks optimal today. Here is an overview of your agency's activity.",
  "Nouveau Contrat": "New Contract",
  "Synthèse Agence": "Agency Summary",
  "Revenus réels ce mois": "Real Income This Month",
  "Taux Occupation": "Occupancy Rate",
  "Cautions": "Deposits",
  "Aucune statistique disponible pour le moment.": "No statistics available at the moment.",
  "Activites recentes": "Recent Activities",
  "Voir tout": "View All",
  "Aucune activite recente.": "No recent activity.",
  "Loyers a venir": "Upcoming Rents",
  "Aucun loyer planifie sur la periode.": "No rent scheduled for this period.",
  "Paiements recents": "Recent Payments",
  "Gestion quittances": "Receipts Management",
  "Aucun paiement enregistre recemment.": "No payment recorded recently.",
  "Loyer recu": "Collected Rent",
  "Reversement": "Payout",
  "completed": "Completed",
  "upcoming": "Upcoming",
  "warning": "Warning",
  "overdue": "Overdue",
  "1er Loyer": "First Rent",
  "Terminé": "Completed",
  "En retard": "Overdue",
  "À venir": "Upcoming",
  "vs mois dernier": "vs last month",
  "Proprietes gerees": "Managed Properties",
  "Total locataires": "Total Tenants",
  "Contrats actifs": "Active Contracts",

  // --- Properties catalog (Parc Immobilier) ---
  "Parc Immobilier": "Properties Catalog",
  "bien enregistré au catalogue": "property registered in the catalog",
  "biens enregistrés au catalogue": "properties registered in the catalog",
  "Exporter": "Export",
  "Nouveau Bien": "New Property",
  "Total Propriétés": "Total Properties",
  "Unités Vacantes": "Vacant Units",
  "Taux d'Occupation": "Occupancy Rate",
  "Standing": "Standing",
  "Économique": "Economic",
  "Moyen": "Medium",
  ...
  "Rechercher par titre, quartier...": "Search by title, neighborhood...",
  "Vacants": "Vacant",
  "Aucun bien trouvé": "No property found",
  "Ajoutez un bien pour commencer la commercialisation.": "Add a property to start leasing.",
  ...
  // --- Bailleurs / Owners ---
  "Fiche bailleur": "Owner File",
  "bailleurs enregistrés": "owners registered",
  "bailleur enregistré": "owner registered",
  "Nouveau Propriétaire": "New Owner",
  "Comptes Actifs": "Active Accounts",
  "Bénéfice Global": "Total Commission",
  "Bénéfice mensuel estimé sur la commission globale agence": "Estimated monthly agency commission earnings",
  "Bailleurs": "Owners",
  "Identifiant": "ID",
  "Biens Possédés": "Properties Owned",
  ...
  "locataires enregistrés": "tenants registered",
  "locataire enregistré": "tenant registered",
  "Nouveau Locataire": "New Tenant",
  "Dossiers Actifs": "Active Records",
  "Baux en cours de validité": "Currently active leases",
  "Loyers Impayés": "Unpaid Rents",
  "Créances locatives cumulées": "Cumulative tenant debts",
  "Rechercher par nom, téléphone...": "Search by name, phone...",
  "Actifs": "Active",
  "Départ": "Move-out",
  "Aucun locataire trouvé": "No tenant found",
  "Créez une fiche locataire pour éditer des contrats de bail.": "Create a tenant record to draft lease contracts.",
  "Ajouter un locataire": "Add a Tenant",

  // --- Contrats / Contracts ---
  "Contrats de Bail": "Lease Contracts",
  "baux enregistrés": "leases registered",
  "bail enregistré": "lease registered",
  "Locatif": "Lease",
  "Gestion": "Mgmt",
  "Taux Comm.": "Comm. Rate",
  "Date Début": "Start Date",
  "Aucun contrat trouvé": "No contract found",
  "Créez un contrat pour associer un locataire à un bien.": "Create a contract to associate a tenant to a property.",

  // --- Caisse / Cash desk ---
  "Journal de Caisse": "Cash Ledger Journal",
  "Encaisser un loyer": "Collect Rent",
  "Décaissement": "Payout / Expense",
  ...
  "Mode": "Method",
  "Auteur": "Author",
  "Aucune transaction enregistrée.": "No transaction recorded.",
  "Enregistrez un encaissement ou un décaissement pour commencer.": "Record a collection or payout to begin.",
};
