...
export const AdminStats: React.FC<AdminStatsProps> = ({ stats, loading, pendingRequestsCount = 0 }) => {
    ...
    const metrics = [
        ...
        {
            label: 'Potentiel Brut Agences',
            value: formatCurrency(stats.globalPotential || 0),
            secondary: `Projection annuelle: ${formatCurrency((stats.globalPotential || 0) * 12)}`,
            icon: TrendingUp,
            gradient: 'from-amber-500 to-orange-600',
            bgLight: 'bg-amber-500/10',
        },
        {
            label: 'Commissions GESTION360 (1%)',
            value: formatCurrency(stats.globalCommissions || 0),
            secondary: 'Revenus plateforme sur baux actifs',
            icon: DollarSign,
