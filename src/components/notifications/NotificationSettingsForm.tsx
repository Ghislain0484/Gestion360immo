    ...
    >
      <div className="space-y-6">
            ...
            {notificationChannels.map((item) => (
              ...
              >
                ...
                <Switch
                  ...
                  onChange={(v: boolean) => handleChange(item.key as keyof NotificationSettings, v)}
                  aria-label={`Activer/désactiver ${item.label}`}
                />
              </Label>
            ))}
        ...
        <div className="flex justify-end gap-3 pt-4 border-t">
          <Button variant="outline" onClick={onCancel} aria-label="Annuler les modifications">
            Annuler
          </Button>
          <Button onClick={onSave} disabled={loading} aria-label="Enregistrer les paramètres">
